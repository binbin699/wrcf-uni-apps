...
export async function checkPermissionStatus(
  ...
  console.log(`[权限检查] 当前平台信息: os=${AppInfo.os}, isApp=${AppInfo.isApp()}, isAndroid=${AppInfo.isAndroidApp()}, isIOS=${AppInfo.isIOSApp()}, isHarmonyApp=${AppInfo.isHarmonyApp()}`)
...
export async function requestPermission(
  ...
  console.log(`[权限请求] 当前平台信息: os=${AppInfo.os}, isApp=${AppInfo.isApp()}, isAndroid=${AppInfo.isAndroidApp()}, isIOS=${AppInfo.isIOSApp()}, isHarmonyApp=${AppInfo.isHarmonyApp()}`)
