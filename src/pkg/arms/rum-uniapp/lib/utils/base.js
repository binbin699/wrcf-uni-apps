"use strict";exports.__esModule=!0,exports.getCurrentTime=getCurrentTime,exports.getStringSize=getStringSize;// /**
//  * 保留指定位数的小数
//  * @param num 原数据
//  * @param decimal 小数位数
//  * @returns
 ...
 * @returns
 */function getCurrentTime(){return new Date().getTime()}function getStringSize(a,b){if(void 0===b&&(b="utf8"),"string"!=typeof a)throw new TypeError("Input must be a string");var c=b.toLowerCase();if("utf16"===c){for(var d,e=0,f=0;f<a.length;f++){// 检查代理对（有效的高位代理后跟低位代理）
